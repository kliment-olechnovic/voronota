...
wget https://github.com/kliment-olechnovic/voronota/releases/download/v1.28.4093/voronota_1.28.4093.tar.gz

# unpack the package
tar -xf ./voronota_1.28.4093.tar.gz

# change to the package directory
cd ./voronota_1.28.4093
