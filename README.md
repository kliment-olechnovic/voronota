...
wget https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4307/voronota_1.29.4307.tar.gz

# unpack the package
tar -xf ./voronota_1.29.4307.tar.gz

# change to the package directory
cd ./voronota_1.29.4307
