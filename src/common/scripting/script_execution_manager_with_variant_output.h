#ifndef COMMON_SCRIPTING_SCRIPT_EXECUTION_MANAGER_WITH_VARIANT_OUTPUT_H_
#define COMMON_SCRIPTING_SCRIPT_EXECUTION_MANAGER_WITH_VARIANT_OUTPUT_H_
...
#endif /* COMMON_SCRIPTING_SCRIPT_EXECUTION_MANAGER_WITH_VARIANT_OUTPUT_H_ */
