...
```bash
wget 'https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4812/cosmopolitan_voronota-lt_v1.1.496.exe'
mv cosmopolitan_voronota-lt_v1.1.496.exe voronota-lt
chmod +x voronota-lt
```
...
```bash
Invoke-WebRequest -Uri 'https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4812/cosmopolitan_voronota-lt_v1.1.496.exe' -OutFile voronota-lt.exe
```
