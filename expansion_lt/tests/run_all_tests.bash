...
voronota-lt -processors 40 -probe 2  < "./input/balls_cs_1x1.xyzr" 2> "./output/contacts_cs_1x1_summary.txt"

voronota-lt -processors 40 -probe 2  < "./input/balls_cs_1x1.xyzr" -periodic-box-corners 0 0 0 200 250 300 2> "./output/contacts_cs_1x1_periodic_summary.txt"
