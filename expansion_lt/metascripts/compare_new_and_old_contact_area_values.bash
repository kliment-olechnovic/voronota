...
cat "${TMPLDIR}/balls" | ./voronota-lt -output-csa -probe 1.4 | egrep '^csa ' | awk '{if($2<$3){print $2 " " $3 " " $4}else{print $3 " " $2 " " $4}}' > "${TMPLDIR}/areas2"
...
plot(x=dt$area1, y=dt$area2, xlab="area AW", ylab="area LT", main="AW vs LT areas", col=densCols(dt$area1, dt$area2));
