...
find /scratch/lustre/kliment/voromqa/output/decoys/contacts/ -type f -name hbplus_output -not -empty | while read FNAME
do
	echo $(dirname $FNAME)
...
for i in {0..5}
do
	cat /scratch/lustre/kliment/voromqa/output/decoys/contacts_list \
	| xargs -L 200 -P 1 \
