...
do
	...
	-o /scratch/lustre/kliment/voromqa/output/casp/energy/energy_without_tags_iss${i}_global
	...
	-o /scratch/lustre/kliment/voromqa/output/casp/energy/models/energy_without_tags_iss${i}_atoms
	...
	-e energy_without_tags_iss${i}_atoms \
	-o /scratch/lustre/kliment/voromqa/output/casp/energy/targets/energy_without_tags_iss${i}_atoms
