...
do
	...
	-o /scratch/lustre/kliment/voromqa/output/casp/energy/energy_without_tags_iss${i}_atoms
	
	sbatch /scratch/lustre/kliment/voromqa/bin/cat_list_of_files.bash \
	-l /scratch/lustre/kliment/voromqa/output/casp/contacts_list \
	-e energy_with_tags_iss${i}_atoms \
	-o /scratch/lustre/kliment/voromqa/output/casp/energy/energy_with_tags_iss${i}_atoms
done
