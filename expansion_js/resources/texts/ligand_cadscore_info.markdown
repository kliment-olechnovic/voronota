...
Example of visualized contacts (with direct interface contacts in green, adjacent contacts in yellow, ligand atoms in red, receptor atoms in cyan): [protein_ligand_3D.png](https://kliment-olechnovic.github.io/voronota/expansion_js/resources/texts/protein_ligand_3D.png).
