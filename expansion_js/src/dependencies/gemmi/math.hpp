...
struct Vec3 {
  ...
  bool   operator==(const Vec3& u) const { return (this->x==u.x)&&(this->y==u.y)&&(this->z==u.z); };
...
struct Mat33 {
  double a[3][3] = { {1.,0.,0.}, {0.,1.,0.}, {0.,0.,1.} };
    ...
    Mat33 operator+(const Mat33& p) const {
        return {a[0][0] + p[0][0], a[0][1] + p[0][1], a[0][2] + p[0][2],
                a[1][0] + p[1][0], a[1][1] + p[1][1], a[1][2] + p[1][2],
                a[2][0] + p[2][0], a[2][1] + p[2][1], a[2][2] + p[2][2]
        };
    }
