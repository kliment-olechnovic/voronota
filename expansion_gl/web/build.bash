...
../src/voronota_gl.cpp ../src/dependencies/imgui/*.cpp ../src/dependencies/lodepng/*.cpp ../../expansion_js/src/dependencies/duktape/duktape.cpp ../../expansion_js/src/dependencies/tmalign/TMalign.cpp \
-DFOR_WEB \
