...
public:
	...
	void document(scripting::CommandDocumentation& doc) const
	{
		...
		doc.set_option_decription(CDOD("molsurf-probe", CDOD::DATATYPE_FLOAT, "probe radius for SES", ""));
		doc.set_option_decription(CDOD("molsurf-grid-step-hint", CDOD::DATATYPE_FLOAT, "grid step size hint for SES", ""));
		doc.set_option_decription(CDOD("molsurf-smoothing", CDOD::DATATYPE_INT, "smoothing steps for SES", ""));
	}
