...
```bash
wget 'https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4723/cosmopolitan_cadscore-lt_v0.9.159.exe'
mv cosmopolitan_cadscore-lt_v0.9.159.exe cadscore-lt
chmod +x cadscore-lt
```
...
```bash
Invoke-WebRequest -Uri 'https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4723/cosmopolitan_cadscore-lt_v0.9.159.exe' -OutFile cadscore-lt.exe
```
...
e.g. [cadscore-lt_v0.9.159.tar.gz](https://github.com/kliment-olechnovic/voronota/releases/download/v1.29.4723/cadscore-lt_v0.9.159.tar.gz).
