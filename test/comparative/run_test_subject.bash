...
( time -p ($TEST_SUBJECT --mode calculate-triangulation --clog-file $LOG_FILE --epsilon $EPSILON --include-surplus-quadruples --print-log < $INPUT_FILE > $RAW_OUTPUT_FILE) ) 2> $RAW_TIME_FILE
