...
$TEST_SUBJECT score-contacts-replacements --potential-file $POTENTIAL_FILE --output-as-matrix > $OUTPUT_SUBDIR/contacts_replacements_matrix
$TEST_SUBJECT score-contacts-replacements --potential-file $POTENTIAL_FILE --residue-level --output-as-matrix > $OUTPUT_SUBDIR/contacts_residue_replacements_matrix
