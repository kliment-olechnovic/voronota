...
($TEST_SUBJECT query-contacts --match-min-seq-sep 1 | $TEST_SUBJECT score-contacts-potential --potential-file $OUTPUT_SUBDIR/contacts_scores_potential_values --defaulting-max-seq-sep 0) < $OUTPUT_SUBDIR/contacts
