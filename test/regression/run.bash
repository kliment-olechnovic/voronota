...
$TEST_SUBJECT --mode calculate-triangulation-in-parallel --print-log --clog-file $OUTPUT_DIR/log_triangulation1p --method simulated --parts 8 --output-balls-graph $OUTPUT_DIR/balls_graph1p --output-vertices-graph $OUTPUT_DIR/vertices_graph1p < $OUTPUT_DIR/balls1 > $OUTPUT_DIR/triangulation1p
