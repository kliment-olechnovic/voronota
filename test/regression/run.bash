...
$TEST_SUBJECT score-contacts --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/target_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/target_iface > $OUTPUT_SUBDIR/target_iface_quality_score_global
$TEST_SUBJECT score-contacts --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/model1_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model1_iface > $OUTPUT_SUBDIR/model1_iface_quality_score_global
$TEST_SUBJECT score-contacts --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/model2_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model2_iface > $OUTPUT_SUBDIR/model2_iface_quality_score_global
