...
$TEST_SUBJECT get-balls-from-atoms-file --radii-file $RADII_FILE --annotated < $INPUT_DIR/complex/target.pdb | $TEST_SUBJECT query-balls --drop-altloc-indicators | $TEST_SUBJECT calculate-contacts --annotated --draw | $TEST_SUBJECT query-contacts --no-same-chain --no-solvent --preserve-graphics > $OUTPUT_SUBDIR/target_iface
$TEST_SUBJECT get-balls-from-atoms-file --radii-file $RADII_FILE --annotated < $INPUT_DIR/complex/model1.pdb | $TEST_SUBJECT query-balls --drop-altloc-indicators | $TEST_SUBJECT calculate-contacts --annotated --draw | $TEST_SUBJECT query-contacts --no-same-chain --no-solvent --preserve-graphics > $OUTPUT_SUBDIR/model1_iface
$TEST_SUBJECT get-balls-from-atoms-file --radii-file $RADII_FILE --annotated < $INPUT_DIR/complex/model2.pdb | $TEST_SUBJECT query-balls --drop-altloc-indicators | $TEST_SUBJECT calculate-contacts --annotated --draw | $TEST_SUBJECT query-contacts --no-same-chain --no-solvent --preserve-graphics > $OUTPUT_SUBDIR/model2_iface
