...
$TEST_SUBJECT get-balls-from-atoms-file --radii-file $RADII_FILE --annotated < $INPUT_DIR/complex/model1.pdb | $TEST_SUBJECT calculate-contacts --annotated --draw | $TEST_SUBJECT query-contacts --no-same-chain --no-solvent --preserve-graphics > $OUTPUT_SUBDIR/model1_iface
$TEST_SUBJECT get-balls-from-atoms-file --radii-file $RADII_FILE --annotated < $INPUT_DIR/complex/model2.pdb | $TEST_SUBJECT calculate-contacts --annotated --draw | $TEST_SUBJECT query-contacts --no-same-chain --no-solvent --preserve-graphics > $OUTPUT_SUBDIR/model2_iface
...
$TEST_SUBJECT query-contacts --inter-residue --set-external-adjuncts <(cat $OUTPUT_SUBDIR/model1_iface_cad_score_inter_residue | awk '{print $1 " " $2 " " (1-$3)}') --set-external-adjuncts-name irs --preserve-graphics < $OUTPUT_SUBDIR/target_iface | $TEST_SUBJECT query-contacts --drawing-for-pymol $OUTPUT_SUBDIR/model1_iface_cad_score_inter_residue_drawing.py --drawing-name model1_iface_cad_score --drawing-adjunct-gradient irs > /dev/null
$TEST_SUBJECT query-contacts --inter-residue --set-external-adjuncts <(cat $OUTPUT_SUBDIR/model2_iface_cad_score_inter_residue | awk '{print $1 " " $2 " " (1-$3)}') --set-external-adjuncts-name irs --preserve-graphics < $OUTPUT_SUBDIR/target_iface | $TEST_SUBJECT query-contacts --drawing-for-pymol $OUTPUT_SUBDIR/model2_iface_cad_score_inter_residue_drawing.py --drawing-name model2_iface_cad_score --drawing-adjunct-gradient irs > /dev/null

$TEST_SUBJECT score-contacts --potential-file $INPUT_DIR/potential --depth 0 --erf-mean 0.75 --inter-residue-scores-file $OUTPUT_SUBDIR/target_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/target_iface > $OUTPUT_SUBDIR/target_iface_quality_score_global
$TEST_SUBJECT score-contacts --potential-file $INPUT_DIR/potential --depth 0 --erf-mean 0.75 --inter-residue-scores-file $OUTPUT_SUBDIR/model1_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model1_iface > $OUTPUT_SUBDIR/model1_iface_quality_score_global
$TEST_SUBJECT score-contacts --potential-file $INPUT_DIR/potential --depth 0 --erf-mean 0.75 --inter-residue-scores-file $OUTPUT_SUBDIR/model2_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model2_iface > $OUTPUT_SUBDIR/model2_iface_quality_score_global

$TEST_SUBJECT query-contacts --inter-residue --set-external-adjuncts <(cat $OUTPUT_SUBDIR/target_iface_quality_score_inter_residue | awk '{print $1 " " $2 " " (1-$3)}') --set-external-adjuncts-name irs --preserve-graphics < $OUTPUT_SUBDIR/target_iface | $TEST_SUBJECT query-contacts --drawing-for-pymol $OUTPUT_SUBDIR/target_iface_quality_score_inter_residue_drawing.py --drawing-name target_iface_quality_score --drawing-adjunct-gradient irs > /dev/null
$TEST_SUBJECT query-contacts --inter-residue --set-external-adjuncts <(cat $OUTPUT_SUBDIR/model1_iface_quality_score_inter_residue | awk '{print $1 " " $2 " " (1-$3)}') --set-external-adjuncts-name irs --preserve-graphics < $OUTPUT_SUBDIR/model1_iface | $TEST_SUBJECT query-contacts --drawing-for-pymol $OUTPUT_SUBDIR/model1_iface_quality_score_inter_residue_drawing.py --drawing-name model1_iface_quality_score --drawing-adjunct-gradient irs > /dev/null
$TEST_SUBJECT query-contacts --inter-residue --set-external-adjuncts <(cat $OUTPUT_SUBDIR/model2_iface_quality_score_inter_residue | awk '{print $1 " " $2 " " (1-$3)}') --set-external-adjuncts-name irs --preserve-graphics < $OUTPUT_SUBDIR/model2_iface | $TEST_SUBJECT query-contacts --drawing-for-pymol $OUTPUT_SUBDIR/model2_iface_quality_score_inter_residue_drawing.py --drawing-name model2_iface_quality_score --drawing-adjunct-gradient irs > /dev/null
