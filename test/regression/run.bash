...
($TEST_SUBJECT query-contacts --match-min-seq-sep 1 | $TEST_SUBJECT score-contacts --detailed-output --ignorable-max-seq-sep 0 --potential-file $OUTPUT_SUBDIR/contacts_scores_potential_values --erf-mean 0.3 --erf-sd 0.2 --inter-atom-scores-file $OUTPUT_SUBDIR/contacts_scores_inter_atom --inter-residue-scores-file $OUTPUT_SUBDIR/contacts_scores_inter_residue --atom-scores-file $OUTPUT_SUBDIR/contacts_scores_atom --residue-scores-file $OUTPUT_SUBDIR/contacts_scores_residue --residue-atomic-scores-file $OUTPUT_SUBDIR/contacts_scores_residue_atomic) < $OUTPUT_SUBDIR/contacts > $OUTPUT_SUBDIR/contacts_scores_global
...
$TEST_SUBJECT compare-contacts --detailed-output --target-contacts-file <(cat $OUTPUT_SUBDIR/target_iface) --inter-residue-scores-file $OUTPUT_SUBDIR/model1_iface_cad_score_inter_residue < $OUTPUT_SUBDIR/model1_iface > $OUTPUT_SUBDIR/model1_iface_cad_score_global
$TEST_SUBJECT compare-contacts --detailed-output --target-contacts-file <(cat $OUTPUT_SUBDIR/target_iface) --inter-residue-scores-file $OUTPUT_SUBDIR/model2_iface_cad_score_inter_residue < $OUTPUT_SUBDIR/model2_iface > $OUTPUT_SUBDIR/model2_iface_cad_score_global
...
$TEST_SUBJECT score-contacts --detailed-output --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/target_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/target_iface > $OUTPUT_SUBDIR/target_iface_quality_score_global
$TEST_SUBJECT score-contacts --detailed-output --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/model1_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model1_iface > $OUTPUT_SUBDIR/model1_iface_quality_score_global
$TEST_SUBJECT score-contacts --detailed-output --potential-file $POTENTIAL_FILE --depth 0 --erf-mean 0.3 --erf-sd 0.2 --inter-residue-scores-file $OUTPUT_SUBDIR/model2_iface_quality_score_inter_residue < $OUTPUT_SUBDIR/model2_iface > $OUTPUT_SUBDIR/model2_iface_quality_score_global
